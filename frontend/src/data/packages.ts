...
/**
 * Authoritative Tour Package Catalogue
 * Single source of truth for tour definitions, routes, itineraries, and durations.
 */
...
export const TOUR_PACKAGES = PACKAGES;
export const MOCK_TOURS = PACKAGES;
